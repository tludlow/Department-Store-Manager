...
FROM StaffSold
    ...
    OverallStaff ON StaffSold.StaffID = OverallStaff.StaffID
WHERE OverallStaff.StaffSalesOfMostSold = (SELECT COUNT(*) FROM MostSoldProducts)
...
INNER JOIN (
    ...
    ) StaffOverall ON BestStaff.StaffID = StaffOverall.StaffID
ORDER BY StaffOverall.StaffSoldAmount DESC;
